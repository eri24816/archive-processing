...
void draw(){
  ...
  dir1=dir(xs1,ys1);
  dir2=dir(xs2,ys2);
  a=cos(dir1-dir)*dist(x1,x2,y1,y2);
  b=sin(dir1-dir)*dist(x1,x2,y1,y2);
  c=cos(dir2-dir)*dist(x1,x2,y1,y2);
  d=sin(dir2-dir)*dist(x1,x2,y1,y2);
  fill(255,255,255);
  ellipse(a,b,10,10);
  ellipse(c,d,10,10);
  nx1=(a+c)/2+cos((b-d)/dist(x1,x2,y1,y2));
  ny1=(b+d)/2+sin((b-d)/dist(x1,x2,y1,y2));
  nx1=(a+c)/2-cos((b-d)/dist(x1,x2,y1,y2));
  ny1=(b+d)/2-sin((b-d)/dist(x1,x2,y1,y2));
  xs1=nx1-x1;
  ys1=ny1-y1;
